...
export interface HealthClaimBeneficiary {
  ...
  readonly newBeneficiaryFlag: boolean;
  readonly paymentDetails: ClaimPaymentDetails;
  ...
  readonly updatedPaymentDetailsFlag: boolean;
}
